...
public class Hierarchy : global::System.IDisposable {
  ...
  public void step(Std2DVeci inputs, System system, bool learn, float reward) {
    eogmaneoPINVOKE.Hierarchy_step__SWIG_0(swigCPtr, Std2DVeci.getCPtr(inputs), System.getCPtr(system), learn, reward);
    if (eogmaneoPINVOKE.SWIGPendingException.Pending) throw eogmaneoPINVOKE.SWIGPendingException.Retrieve();
  }

  public void step(Std2DVeci inputs, System system, bool learn) {
    eogmaneoPINVOKE.Hierarchy_step__SWIG_1(swigCPtr, Std2DVeci.getCPtr(inputs), System.getCPtr(system), learn);
    if (eogmaneoPINVOKE.SWIGPendingException.Pending) throw eogmaneoPINVOKE.SWIGPendingException.Retrieve();
  }

  public void step(Std2DVeci inputs, System system) {
    eogmaneoPINVOKE.Hierarchy_step__SWIG_2(swigCPtr, Std2DVeci.getCPtr(inputs), System.getCPtr(system));
    if (eogmaneoPINVOKE.SWIGPendingException.Pending) throw eogmaneoPINVOKE.SWIGPendingException.Retrieve();
  }
